...
<head>
    ...
    <script>
        var UEDITOR_HOME_URL = "/ssm_news/ueditor/";//从项目的根目录开始
    </script>
...
<div class="row">
    ...
    <div class="col-md-10"><span class="label label-info">查看新闻具体内容</span></div>
    <div class="col-md-1"></div>
</div>
