...
<div class="row">
    ...
    <div class="col-md-9"><span class="label label-info">新闻管理</span></div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered">
                ...
                <tr class="success">
                    ...
                    <td ><span class="label label-success">修改操作</span></td>
                </tr>
                </thead>
                <c:forEach items="${news}" var="n">
                    <tr>
                        ...
                        <td><a href="delete_anew?id=${n.id}"><span class="glyphicon glyphicon-remove"></span></a></td>
                        <td><a href="new_update?id=${n.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
